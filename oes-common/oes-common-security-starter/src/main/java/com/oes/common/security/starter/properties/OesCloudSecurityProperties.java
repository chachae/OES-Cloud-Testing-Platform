package com.oes.common.security.starter.properties;
 ...
 * @author chachae
 */
@ConfigurationProperties(prefix = "oes.cloud.security")
public class OesCloudSecurityProperties {
  ...
  public String toString() {
    return "OesCloudSecurityProperties{" +
        "enable=" + enable +
        ", authUri='" + authUri + '\'' +
        ", anonUris='" + anonUris + '\'' +
