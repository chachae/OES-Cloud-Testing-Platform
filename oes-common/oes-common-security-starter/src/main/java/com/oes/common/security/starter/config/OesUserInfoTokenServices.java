 ...
 * @version v1.0
 */
public class OesUserInfoTokenServices implements ResourceServerTokenServices {
  ...
  public OesUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
