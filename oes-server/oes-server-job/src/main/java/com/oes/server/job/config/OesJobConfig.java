package com.oes.server.job.config;
...
/**
 * 定时任务配置 http://www.quartz-scheduler.org/documentation/quartz-2.3.0/configuration/
 *
 * @author chachae
 */
@Configuration
@RequiredArgsConstructor
public class OesJobConfig {
  ...
  public ThreadPoolTaskExecutor scheduleJobExecutorService() {
    ...
    executor.setThreadNamePrefix("OES-Job-Thread");
  ...
  public SchedulerFactoryBean schedulerFactoryBean() {
    ...
    prop.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_ID,
    ...
    factory.setSchedulerName("OES_Cloud_Scheduler");
    // 延时启动
