package com.oes.gateway.common.handler;
 ...
 */
@Slf4j
public class OesGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

  public OesGatewayExceptionHandler(ErrorAttributes errorAttributes,
