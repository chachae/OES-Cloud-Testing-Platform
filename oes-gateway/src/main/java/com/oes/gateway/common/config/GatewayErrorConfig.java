package com.oes.gateway.common.config;

import com.oes.gateway.common.handler.OesGatewayExceptionHandler;
...
public class GatewayErrorConfig {
  ...
  public ErrorWebExceptionHandler errorWebExceptionHandler(ErrorAttributes errorAttributes) {
    OesGatewayExceptionHandler exceptionHandler = new OesGatewayExceptionHandler(
